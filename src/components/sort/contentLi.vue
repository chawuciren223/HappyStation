...
.sort-content-list li a .image img {
  width: 100%;
  height: 100%;
  border-radius: 6px;
}

.sort-content-list li a .image p {
  position: absolute;
  width: 100%;
  height: 25px;
  font-size: 13px;
...
.sort-content-list li a .image .score {
  position: absolute;
  top: 8px;
  left: 0;
  width: 40px;
...
.sort-content-list li a .image .mask {
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
...
.sort-content-list li a .image:hover .mask {
  display: block;
}

.sort-content-list li a h4 {
  font-size: 15px;
  margin: 5px 0;
}

.sort-content-list li a p {
  font-size: 12px;
  overflow: hidden;
  -webkit-line-clamp: 1;
...
.sort-content-list li a:hover .show {
  opacity: 1;
  top: -5px;
  left: -10px;
  /* display: block; */
